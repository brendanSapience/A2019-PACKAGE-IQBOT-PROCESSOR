...
public final class TransformColumnWithRegexCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(TransformColumnWithRegexCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    TransformColumnWithRegex command = new TransformColumnWithRegex();
