...
public final class KeepRowsWithRegexCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(KeepRowsWithRegexCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    KeepRowsWithRegex command = new KeepRowsWithRegex();
